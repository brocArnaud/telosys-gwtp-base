...
public class BadgeListViewImpl extends AbstractListView<BadgeListPresenter, BadgeDto> implements BadgeListView {
	...
	public void initCellTable() {
		...
		final TextColumn<BadgeDto> col3 = new TextColumn<BadgeDto>() {
			...
			@Override
			public String getValue(final BadgeDto object) {
				GWT.log("======================> laala object.getEndOfValidity( :"+object.getEndOfValidity());
				return String.valueOf(object.getEndOfValidity());
			}
		};
		table.addColumn(col3, "End of validity");
		final Column<BadgeDto, String> deletion = new Column<BadgeDto, String>(new ButtonCell(ButtonType.DANGER, IconType.TRASH)) {
			@Override
			public String getValue(BadgeDto object) {
				return "";
			}
		};
		...
		final Column<BadgeDto, String> update = new Column<BadgeDto, String>(new ButtonCell(ButtonType.SUCCESS, IconType.PENCIL)) {
			@Override
			public String getValue(BadgeDto object) {
				return "";
			}
