...
public class CustomerListViewImpl extends AbstractListView<CustomerListPresenter, CustomerDto> implements CustomerListView {
	...
	public void initCellTable() {
		...
		final Column<CustomerDto, String> deletion = new Column<CustomerDto, String>(new ButtonCell(ButtonType.DANGER, IconType.TRASH)) {
			@Override
		...
		final Column<CustomerDto, String> update = new Column<CustomerDto, String>(new ButtonCell(ButtonType.SUCCESS, IconType.PENCIL)) {
			@Override
			public String getValue(CustomerDto object) {
				return "";
			}
