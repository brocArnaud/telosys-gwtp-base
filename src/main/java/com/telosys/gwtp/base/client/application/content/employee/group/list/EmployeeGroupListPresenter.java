...
public class EmployeeGroupListPresenter extends AbstractListPresenter<EmployeeGroupListProxy, EmployeeGroupListView, EmployeeGroupDto, EmployeeGroupResource> {
	...
	@Inject
	EmployeeGroupListPresenter(EventBus eventBus, EmployeeGroupListView view, EmployeeGroupListProxy proxy, PlaceManager placeManager, RestDispatch dispatcher) {
